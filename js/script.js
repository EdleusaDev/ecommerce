...
window.fazerLogin = function() {
    ...
    document.getElementById('product-list').innerHTML = `
        <div class="container" style="color: white; padding: 50px; background-color: #1a1a1a; margin-top: 20px; border-radius: 10px; border: 1px solid #FF007F;">
            ...
            <form>
                <input type="text" placeholder="Usuário" style="display: block; margin: 10px auto; padding: 10px; width: 80%; color: black;">
                <input type="password" placeholder="Senha" style="display: block; margin: 10px auto; padding: 10px; width: 80%; color: black;">
